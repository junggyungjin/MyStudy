 ...
 * 객체란 뭘까?
 * - 이름이 있는 모든 것
 * 절차지향 프로그래밍 문제 해결방법 -> 코드를 위에서부터 아래로 실행을 하면 문제가 해결된다!
 * 객체지향 프로그래밍 문제 해결방법 -> 객체를 만들어서 객체에게 일을 시켜서 문제를 해결한다!
 * 선수, 심판, 경기장, 관중 -> 축구 게임
...
fun main(array: Array<String>) {
    ...
    val bigCar1: Car = Car("vi engine", "big")

//    val superCar: SuperCar = SuperCar("goodengine", "big", "white")
